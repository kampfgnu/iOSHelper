 ...
 */
typedef enum {
	KGUIViewAlignmentUnchanged,
	KGUIViewAlignmentLeftAligned,
	KGUIViewAlignmentRightAligned,
    KGUIViewAlignmentTopAligned,
    KGUIViewAlignmentBottomAligned,
	KGUIViewAlignmentCentered
} KGUIViewAlignment;
...
/**
 ...
 Origin.x isn't changed, because KGUIViewAlignmentUnchanged is used.
...
/**
 ...
 Origin.y isn't changed, because KGUIViewAlignmentUnchanged is used.
