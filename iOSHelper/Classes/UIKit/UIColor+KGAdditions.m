...
//    KGAssert(color != nil, @"Cannot compute inverse color to nil");
...
//    KGAssert(color1 != nil && color2 != nil, @"Colors must be non-nil to calculate difference");
...
////////////////////////////////////////////////////////////////////////
#pragma mark - UIColor+KGAdditions
////////////////////////////////////////////////////////////////////////
...
- (UInt32)RGBHex {
	...
	CGFloat r = KGLimitFloat(self.red, 0.f, 1.f);
    CGFloat g = KGLimitFloat(self.green, 0.f, 1.f);
    CGFloat b = KGLimitFloat(self.blue, 0.f, 1.f);
